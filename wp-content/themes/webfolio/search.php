...
<!-- begin colLeft -->
	...
	<?php if (have_posts()) : while (have_posts()) : the_post();
		...
		<div class="blogPost clearfix">
			...
			<div class="meta">
				<img src="<?php bloginfo('template_directory'); ?>/images/ico_file.png" alt="Posted" /> Posted by Danny Jensen in <?php the_category(', ') ?> &nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php bloginfo('template_directory'); ?>/images/ico_comments.png" alt="Comments" /> <?php comments_popup_link('No comments', '1 comment', '% comments'); ?>
